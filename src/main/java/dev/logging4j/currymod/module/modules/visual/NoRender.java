...
public class NoRender extends Module {
    ...
    private final OptionBoolean advancements = new OptionBoolean("Advancements", true);

    public NoRender() {
        addOptions(hurtCam, fire, pumpkin, powderSnow, liquid, wall, spyGlass, portal, guiBackground, armor, advancements);
    }
