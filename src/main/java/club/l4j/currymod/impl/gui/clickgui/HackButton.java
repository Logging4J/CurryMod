...
import club.l4j.currymod.impl.gui.clickgui.components.*;
...
public class HackButton implements IGlobals {
    ...
    public void render(DrawContext context, int mouseX, int mouseY, float delta) {
        ...
        context.drawTextWithShadow(mc.textRenderer, hack.getName(), window.x + 1, window.y + yOffset + 1,  hack.isEnabled() ? CurryMod.colorManager.getRGBA() : -1);
