...
public class LocationElement extends HudElement {
    ...
    public void render(DrawContext context) {
        ...
        int netherZ = (int) Math.round(pos.y / 8.0);
        ...
        String coordsStr = String.format("%.2f, %.2f, %.2f " + Formatting.GRAY + "[" + Formatting.WHITE + "%d, %d" + Formatting.GRAY + "]", pos.x, pos.y, pos.z, netherX, netherZ);
