...
public class Offhand extends Module implements ITickListener {
    ...
    public void onTick() {
        ...
        if (offhandItem.found()) {
            ...
            InventoryUtils.windowClick(mc.player.currentScreenHandler, slot < 9 ? slot + 36 : slot, SlotActionType.SWAP, 40);
        }
    }
