...
public class Direction extends HudElement {
    ...
    public void onRender(DrawContext context, float tickDelta) {
        ...
        context.drawTextWithShadow(mc.textRenderer, "Direction:" + TextUtil.GRAY + mc.getCameraEntity().getHorizontalFacing(), 2, 22 + mc.textRenderer.fontHeight * 4, Managers.getColorManager().getRGBA());
    }
}
