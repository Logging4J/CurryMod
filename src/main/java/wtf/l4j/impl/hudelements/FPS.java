...
public class FPS extends HudElement {
    ...
    public void onRender(DrawContext context, float tickDelta) {
        context.drawTextWithShadow(mc.textRenderer,"FPS " + TextUtil.GRAY + mc.getCurrentFps(), 0, mc.getWindow().getScaledHeight() - (mc.textRenderer.fontHeight * 3), Managers.getColorManager().getRGBA());
    }
}
